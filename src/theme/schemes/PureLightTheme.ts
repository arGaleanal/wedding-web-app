...
// const PatternBackground = require('../../utils/images/contentbkgd_redwood1.png');

const themeColors = {
  primary: '#c19e4c',//
  secondary: '#312d2b',//#312d2beb
  success: '#57CA22',
  warning: '#FFA319',
  error: '#FF1943',
  info: '#33C2FF',
...
export const PureLightTheme = createTheme({
  ...
  palette: {
    ...
    text: {
      primary: colors.secondary.main,//colors.alpha.black[100],
      secondary: colors.secondary.light,//colors.alpha.black[70],
    ...
    action: {
      ...
      selectedOpacity: 0.1,
      disabled: colors.alpha.black[50],
      disabledBackground: colors.primary.lighter,
  ...
  components: {
    ...
    MuiCssBaseline: {
      styleOverrides: {
        ...
        '#root': {
          ...
          // background: `url(${PatternBackground}) no-repeat center center fixed`,
        },
        html: {
          display: 'flex',
          flexDirection: 'column',
    ...
    MuiPaper: {
      styleOverrides: {
        ...
        elevation: {
          ...
          boxShadow: '0 2px 4px 0 rgb(0,0,0, 0.10)'
        },
        elevation2: {
          //boxShadow: colors.shadows.cardSm
          boxShadow: '0 2px 4px 0 rgb(0,0,0, 0.10)'
    ...
    MuiSwitch: {
      styleOverrides: {
        ...
        colorPrimary: {
          '& .MuiSwitch-thumb': {
            backgroundColor: colors.alpha.white[70]
          },
